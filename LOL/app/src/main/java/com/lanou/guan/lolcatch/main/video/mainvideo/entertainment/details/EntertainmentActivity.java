 ...
 */
public class EntertainmentActivity extends BaseActivity implements MyClickListener{
    private int pos;
    ...
    private EntertainmentAtvAdapter atvAdapter;
    private  String id;
    private String url;
    ...
    public void initView() {
        ...
        Log.d("EntertainmentActivity", id);
    ...
    public void initData() {
        initResponse();
        atvAdapter = new EntertainmentAtvAdapter(this);
    ...
    public void initResponse(){
        ...
        GsonRequest<EntertainmentAtyBean> request = new GsonRequest<>(com.android.volley.Request.Method.GET,abc,new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {

            }
        }, new Response.Listener<EntertainmentAtyBean>() {
            @Override
            public void onResponse(EntertainmentAtyBean response) {
                bean = response;
                atvAdapter.setBean(bean);
            }
        },EntertainmentAtyBean.class);
        queue.add(request);
    }
