...
public class VolleySingle {
    ...
    public <T> void _addRequest(String url, Response.ErrorListener errorListener,Response.Listener<T> listener, Class<T> mClass ){
    ...
    public static  <T> void addRequest(String url , Response.ErrorListener errorListener,Response.Listener<T> listener,Class<T> mClass){
